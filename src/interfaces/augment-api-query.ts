...
import type { BridgeChainId, DepositNonce, ProposalVotes, ResourceId } from 'automata-typings/interfaces/chainbridge';
import type { Chain, ChainIndex, DAOProposal, Project, ProjectId, ProposalId } from 'automata-typings/interfaces/daoportal';
...
declare module '@polkadot/api-base/types/storage' {
  export interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    daoPortal: {
      chains: AugmentedQuery<ApiType, (arg: ChainIndex | AnyNumber | Uint8Array) => Observable<Option<Chain>>, [ChainIndex]> & QueryableStorageEntry<ApiType, [ChainIndex]>;
      latestChainIndex: AugmentedQuery<ApiType, () => Observable<ChainIndex>, []> & QueryableStorageEntry<ApiType, []>;
      latestProjectId: AugmentedQuery<ApiType, () => Observable<ProjectId>, []> & QueryableStorageEntry<ApiType, []>;
      latestProposalId: AugmentedQuery<ApiType, (arg: ProjectId | AnyNumber | Uint8Array) => Observable<ProposalId>, [ProjectId]> & QueryableStorageEntry<ApiType, [ProjectId]>;
      projects: AugmentedQuery<ApiType, (arg: ProjectId | AnyNumber | Uint8Array) => Observable<Option<Project>>, [ProjectId]> & QueryableStorageEntry<ApiType, [ProjectId]>;
      proposals: AugmentedQuery<ApiType, (arg1: ProjectId | AnyNumber | Uint8Array, arg2: ProposalId | AnyNumber | Uint8Array) => Observable<Option<DAOProposal>>, [ProjectId, ProposalId]> & QueryableStorageEntry<ApiType, [ProjectId, ProposalId]>;
      relayer: AugmentedQuery<ApiType, () => Observable<AccountId>, []> & QueryableStorageEntry<ApiType, []>;
      voteFee: AugmentedQuery<ApiType, () => Observable<BalanceOf>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    game: {
      attackCount: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
