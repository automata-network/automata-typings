...
import type { BridgeChainId, BridgeTokenId, DepositNonce, ProposalStatus, ProposalVotes, ResourceId } from 'automata-typings/interfaces/chainbridge';
import type { Chain, ChainIndex, CrossChainAccount, DAOProposal, DAOProposalState, DAOProposalStatus, IpfsHash, OptionIndex, PrivacyLevel, Project, ProjectId, ProposalId, Protocol, SolidityStrategy, Strategy, SubstrateStrategy, VoteUpdate, VotingFormat, VotingPower, Workspace } from 'automata-typings/interfaces/daoportal';
