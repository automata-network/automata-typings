...
import type { Chain, ChainIndex, CrossChainAccount, DAOProposal, DAOProposalState, IpfsHash, OptionIndex, PrivacyLevel, Project, ProjectId, ProposalId, Protocol, SolidityStrategy, Strategy, SubstrateStrategy, UserGroup, VoteUpdate, VotingFormat, VotingPower, Workspace } from 'automata-typings/interfaces/daoportal';
